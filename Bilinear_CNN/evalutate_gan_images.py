"""this will be used to evaluate the gan images """
...
def evaluate_model():
    ...
    gen_dir_train, gen_dir_test = load_generators(path_train='./images/splitted/train', path_test='./images/test/GAN_TEST/')
    ...
    results.to_csv("results_GAN.csv", index=False)
    print('Done')
